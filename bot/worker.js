...
const DEFAULT_MARKER_IMAGES = {
  black: "data:image/webp;base64,",
  brown: "data:image/webp;base64,",
  white: "data:image/webp;base64,"
};
...
async function ensureDefaultCityVisuals(env, territoryId) {
  ...
  const legacyCategoryId='default-category-marker';
  await env.DB.prepare(`INSERT OR IGNORE INTO customization_categories (id,name,created_by,created_at) VALUES (?,?,?,?)`).bind(legacyCategoryId,'Метка',0,Date.now()).run();
  const defaults=[
  ...
  for(const [itemId,name,image,color] of defaults){
    await env.DB.prepare(`INSERT OR IGNORE INTO customization_items (id,category_id,name,price,image_data,active,created_by,created_at,categories_text,color) VALUES (?,?,?,?,?,1,?,?,?,?)`).bind(itemId,categoryId,name,0,image,0,Date.now(),'За достижения, Метка',color).run();
    await env.DB.prepare(`UPDATE customization_items SET category_id=?,image_data=?,active=1,categories_text='За достижения, Метка',color=? WHERE id=?`).bind(categoryId,image,color,itemId).run();
...
async function getTerritories(env) {
  try{
    ...
    await Promise.all((result.results||[]).map(row=>ensureDefaultCityVisuals(env,row.id)));
