...
async function updateCustomizationItem(request,env,itemId){
  ...
  return json({ok:true,item:{id,name,price,image_data:imageData,category_id:categoryIds[0],categories_text:categories.join(', '),color,achievement_enabled:achievement.enabled?1:0,government_marker:governmentMarker?1:0}});
}
